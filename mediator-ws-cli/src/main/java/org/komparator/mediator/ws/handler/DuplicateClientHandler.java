...
public class DuplicateClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public static final String CLASS_NAME = DuplicateClientHandler.class.getSimpleName();
